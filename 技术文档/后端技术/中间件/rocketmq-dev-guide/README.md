...
>
> 原始文档地址：<https://github.com/apache/rocketmq/tree/rocketmq-all-4.5.1/docs/cn>
>
> 考虑到官方原始地址访问慢、藏得深、难找、检索不便等问题，故而挪过来了。
>
> 此外，笔者还将官方文档编译成了PDF文件，**同学们可直接下载PDF文件，阅读、标记、做笔记啥的。PDF下载地址**：[Apache RocketMQ开发者指南](https://git.imooc.com/coding-358/rocketmq-dev-guide/src/master/book.pdf)
